...
- **步骤 5:** 在 `package.json`.添加一些`script`
  ...
  具体位置如下图：
<a data-fancybox title="vitepress1" href="https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202304280218888.png">![vitepress1](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202304280218888.png)</a>
