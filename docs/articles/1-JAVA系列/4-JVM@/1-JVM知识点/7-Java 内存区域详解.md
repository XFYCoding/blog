...
![](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041752829.png)

**JDK 1.8 之后** ：

![](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041753242.png)
...
![](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041754932.png)

**局部变量表** 主要存放了编译期可知的各种数据类型（boolean、byte、char、short、int、float、long、double）、对象引用（reference 类型，它不同于对象本身，可能是一个指向对象起始地址的引用指针，也可能是指向一个代表对象的句柄或其他与此对象相关的位置）。

![局部变量表](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041754589.png)

**操作数栈** 主要作为方法调用的中转站使用，用于存放方法执行过程中产生的中间计算结果。另外，计算过程中产生的临时变量也会放在操作数栈中。

**动态链接** 主要服务一个方法需要调用其他方法的场景。Class 文件的常量池里保存有大量的符号引用比如方法引用的符号引用。当一个方法要调用其他方法，需要将常量池中指向方法的符号引用转化为其在内存地址中的直接引用。动态链接的作用就是为了将符号引用转换为调用方法的直接引用，这个过程也被称为 **动态连接** 。

![](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041754895.png)
...
![](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041754971.png)
...
![hotspot-heap-structure](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041755747.png)
...
![HotSpot 虚拟机方法区的两种实现](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041756796.png)

**为什么要将永久代 (PermGen) 替换为元空间 (MetaSpace) 呢?**

下图来自《深入理解 Java 虚拟机》第 3 版 2.2.5

![](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041755600.png)
...
![符号引用和直接引用](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041756743.png)
...
![method-area-jdk1.6](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041757059.png)

![method-area-jdk1.7](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041757550.png)
...
![对象的访问定位-使用句柄](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041758697.png)

#### 直接指针

如果使用直接指针访问，reference 中存储的直接就是对象的地址。

![对象的访问定位-直接指针](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041758584.png)
