...
![hotspot-heap-structure](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041746227.png)
...
通过以下方式运行：
![](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041746290.png)

添加的参数：`-XX:+PrintGCDetails`
![](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041746685.png)

运行结果 (红色字体描述有误，应该是对应于 JDK1.7 的永久代)：

![](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041746306.jpeg)
...
![](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041746241.jpeg)
...
>
> ![](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041746711.png)
>
> **动态年龄计算的代码如下：**
>
> ```c
...
![rf-hotspot-vm-gc](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041831822.png)
...
![可达性分析算法](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041748279.png)
...
![](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041747284.jpeg)

### 标记-复制算法

为了解决效率问题，“标记-复制”收集算法出现了。它可以将内存分为大小相同的两块，每次使用其中的一块。当这一块的内存使用完后，就将还存活的对象复制到另一块去，然后再把使用的空间一次清理掉。这样就使每次的内存回收都是对内存区间的一半进行回收。

![复制算法](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041747902.png)

### 标记-整理算法

根据老年代的特点提出的一种标记算法，标记过程仍然与“标记-清除”算法一样，但后续步骤不是直接对可回收对象回收，而是让所有存活的对象向一端移动，然后直接清理掉端边界以外的内存。

![标记-整理算法 ](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041747366.png)
...
![ Serial 收集器 ](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041747590.png)
...
![ParNew 收集器 ](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041747844.png)
...
![Parallel Scavenge 收集器 ](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041747168.png)
...
![CMS 垃圾收集器 ](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041747413.png)
