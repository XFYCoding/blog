...
![java虚拟机](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041726494.png)
...
![ClassFile 内容分析](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041727891.jpeg)

下面这张图是通过 IDEA 插件 `jclasslib` 查看的，你可以更直观看到 Class 文件结构。

![](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041727670.png)
...
![类访问和属性修饰符](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041727961.png)
...
![查看类的访问标志](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041727327.png)
...
![字段的 access_flag 的取值](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041727102.png)
...
![方法表的结构](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041727690.png)

**方法表的 access_flag 取值：**

![方法表的 access_flag 取值](https://cdn.jsdelivr.net/gh/xfycoding/blogImage/img/202305041727589.png)
