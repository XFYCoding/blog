...
export default {
  ...
  methods: {
    innit() {
      const cloudContent = document.querySelector(".wordCloud__tagBall");
      this.width = cloudContent.offsetWidth;
      this.height = cloudContent.offsetHeight;
